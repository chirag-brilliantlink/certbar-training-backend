...
export interface ApiBusinessBusiness extends Schema.SingleType {
  ...
  attributes: {
    business_page: Attribute.DynamicZone<
      [
...
export interface ApiBusinessNavBusinessNav extends Schema.CollectionType {
  collectionName: 'business_navs';
  info: {
    singularName: 'business-nav';
    pluralName: 'business-navs';
    displayName: 'Business-nav';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiCareerPathCareerPath extends Schema.SingleType {
...
export interface ApiDefensiveSecurityDefensiveSecurity
  extends Schema.CollectionType {
  collectionName: 'defensive_securities';
  info: {
...
export interface ApiEthicalHackingEthicalHacking extends Schema.SingleType {
  collectionName: 'ethical_hackings';
  info: {
    singularName: 'ethical-hacking';
    pluralName: 'ethical-hackings';
  ...
  attributes: {
    ethical_hacking: Attribute.DynamicZone<
      [
        'shared.card-with-list-section',
        'shared.content-with-two-section',
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::ethical-hacking.ethical-hacking',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiOffensiveSecurityOffensiveSecurity
  extends Schema.CollectionType {
  collectionName: 'offensive_securities';
  info: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::business-nav.business-nav': ApiBusinessNavBusinessNav;
      'api::career-path.career-path': ApiCareerPathCareerPath;
      'api::defensive-security.defensive-security': ApiDefensiveSecurityDefensiveSecurity;
      'api::ethical-hacking.ethical-hacking': ApiEthicalHackingEthicalHacking;
